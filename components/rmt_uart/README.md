...
Component for Espressif ESP32 ESP-IDF V5.x framework.
...
|----------------|--------------------|------------|----------
| ESP32-S2 | ESP-IDF            | v5.0 and above  |   2
| ESP32-C3 | ESP-IDF            | v5.0 and above  |   2
| ESP32-C6 | ESP-IDF            | v5.0 and above  |   2
| ESP32-S3 | ESP-IDF            | v5.0 and above  |   4
